...
{
    public class BigLegoProjectile : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<BigLegoExplosion>(), Projectile.damage, Projectile.knockBack, Projectile.owner);
        }
        ...
        public override void AI()
        {
            ...
            Dust d = Dust.NewDustPerfect(
             Projectile.Center,
             DustID.GemRuby,
             Main.rand.NextVector2Circular(35f, 35f),
             150,
             default,
             4f
          );
    ...
    public class BigLegoExplosion : ModProjectile
    {
        public override void SetDefaults()
        {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            {
                int debuffType = calamityMod.Find<ModBuff>("GodSlayerInferno").Type;
                target.AddBuff(debuffType, 240);
            }
            else target.AddBuff(BuffID.CursedInferno, 240);
